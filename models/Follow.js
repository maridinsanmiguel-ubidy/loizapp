...
Follow.prototype.validate = async function(action) {
    ...
    if (action == "create") {
        if (doesFollowedAlreadyExist) {this.errors.push("You are already followed this user.")}
    }
    if (action == "delete") {
        if (!doesFollowedAlreadyExist) {this.errors.push("You cannot stop following someone you do not already follow.")}
    }
